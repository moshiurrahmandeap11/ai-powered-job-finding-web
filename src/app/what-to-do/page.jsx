...
const WhatToDo = () => {
  ...
  const purposes = [
    {
      id: "find_job",
      title: "Find a Job",
      description: "I'm looking for new job opportunities",
      icon: "💼",
      color: "blue"
    },
    {
      id: "career_growth",
      title: "Career Growth",
      description: "I want to advance in my current career",
      icon: "📈",
      color: "green"
    },
    {
      ...
      description: "I want to learn new skills and technologies",
      icon: "🎓",
      color: "purple"
    },
    {
      ...
      description: "I want to connect with other professionals",
      icon: "🤝",
      color: "orange"
    },
    {
    ...
    },
    {
      ...
      description: "I have ideas and want to build my own company",
      icon: "🚀",
      color: "red"
    },
    {
      ...
      description: "I need guidance from experienced professionals",
      icon: "👨‍🏫",
      color: "indigo"
    },
    {
      ...
      description: "I want to showcase my work and projects",
      icon: "🎨",
      color: "pink"
    },
    {
      ...
      description: "I need help preparing for technical interviews",
      icon: "🎯",
      color: "yellow"
    },
    {
      id: "career_change",
      title: "Career Change",
      description: "I want to switch to a different field",
      icon: "🔄",
      color: "teal"
    },
    {
      ...
      description: "I want to learn how to negotiate better salary",
      icon: "💰",
      color: "emerald"
    },
    {
      ...
      description: "I'm exploring different career options",
      icon: "🔍",
      color: "gray"
    }
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Update user with selected purpose
