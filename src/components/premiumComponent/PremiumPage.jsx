                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {packages.map((pkg, index) => (
                        <motion.div
                            ...
                            className={`relative rounded-2xl overflow-hidden ${pkg.popular ? "ring-2 ring-blue-500 ring-offset-2" : "border border-gray-200"} shadow-lg`}
                        >
                            {pkg.popular && (
                            ...
                            <div className="bg-white p-6 pt-7"> {/* Added pt-7 to give space for the badge */}
                                ...
                                <ul className="space-y-4">
                                    {pkg.features.map((feature, featureIndex) => (
                                        <li key={featureIndex} className="flex items-start">
                                            <Check size={18} className={`mt-0.5 mr-3 flex-shrink-0 ${feature.unlimited ? "text-green-500" : "text-gray-400"}`} />
                                            <div>
                                                <span className="font-medium text-gray-900">{feature.name}</span>
                                                <span className={`block text-sm ${feature.unlimited ? "text-green-600 font-medium" : "text-gray-600"}`}>
                                                    {feature.value}
                                                </span>
                                            </div>
                                        </li>
                ...
                <div className="max-w-3xl mx-auto mt-20">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <p className="text-gray-600">Yes, you can upgrade or downgrade your plan at any time. When upgrading, the new features are available immediately. When downgrading, the changes take effect at the end of your billing cycle.</p>
                        </div>

                        <div className="bg-white rounded-lg shadow p-6">
                            <h3 className="text-lg font-medium text-gray-900 mb-2">How does the AI resume scoring work?</h3>
                            <p className="text-gray-600">Our AI analyzes your resume against industry standards, job descriptions, and successful resumes in your field. It provides a score and specific recommendations to improve your chances of getting noticed by employers.</p>
                        </div>

                        <div className="bg-white rounded-lg shadow p-6">
                            <h3 className="text-lg font-medium text-gray-900 mb-2">What payment methods do you accept?</h3>
                            <p className="text-gray-600">We accept all major credit cards, PayPal, and in some regions, bank transfers. All payments are securely processed through our encrypted payment system.</p>
                        </div>

                        <div className="bg-white rounded-lg shadow p-6">
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Is there a free trial for paid plans?</h3>
                            <p className="text-gray-600">Yes, we offer a 7-day free trial for both Standard and Premium plans. No credit card is required to start the trial, and you can cancel anytime during the trial period without being charged.</p>
                        </div>
                    </div>
                </div>
            </div>
