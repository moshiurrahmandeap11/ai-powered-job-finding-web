...
const Hero = ({ onClose }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-4">
      ...
      <section className="relative max-w-3xl w-full bg-white/90 rounded-xl px-4 py-6 lg:py-10 shadow-xl transform animate-slideDown">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-1 lg:top-4 right-4 text-gray-700 hover:text-gray-900 transition cursor-pointer"
        >
          <X size={24} />
        </button>
